        ...
        <div className="max-w-md mb-12">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-full bg-[#FAF8F2] border border-[#141413]/20 font-sans text-xs text-[#141413] placeholder:text-[#6B6862] focus:outline-none focus:border-[#141413]"
            />
          </div>
        </div>
